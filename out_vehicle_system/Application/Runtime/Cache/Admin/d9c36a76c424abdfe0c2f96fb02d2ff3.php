...
<div class="allContent">
    <form class="layui-form" action="" method="post">
        ...
        <input type="checkbox" name="manage_order" title="订单管理" checked>
        <input type="checkbox" name="manage_driver" title="司机管理">
        <input type="checkbox" name="manage_vehicle" title="车辆管理">
        <input type="checkbox" name="manage_role" title="角色管理">
        <input type="checkbox" name="manage_diary" title="日记管理">
        <div class="layui-form-item toInline">
            <div class="layui-input-block">
    ...
    <form class="layui-form" action="" method="post" id="addPermissions">
        ...
        <div class="layui-form-item toInline">
            <div class="layui-input-inline">
                <button class="layui-btn" lay-submit lay-filter="permissions">立即提交</button>
                <button type="reset" class="layui-btn layui-btn-primary">重置</button>
            </div>
        </div>
    </form>
